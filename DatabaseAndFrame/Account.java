...
public class Account extends JFrame {
    ...
    private JCheckBox chkShowPassword; // Tambahan JCheckBox
    ...
    public Account(String username, int userId) {
        ...
        grid.insets = new Insets(0, 10, 10, 10); // Merapatkan jarak dengan text field di atasnya
        ...
        // Logika menyembunyikan/menampilkan password
        chkShowPassword.addActionListener(e -> {
            if (chkShowPassword.isSelected()) {
                txtNewPassword.setEchoChar((char) 0); // Menampilkan text
            } else {
                txtNewPassword.setEchoChar('•'); // Menyembunyikan text
            }
        });
        panelRight.add(chkShowPassword, grid);

        // Menurunkan Grid Y untuk tombol karena adanya Checkbox
