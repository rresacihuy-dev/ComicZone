...
public class AdminDashboard extends JFrame {
    ...
    private JComboBox<String> cbTypeInput; // PERBAIKAN: Menggunakan JComboBox untuk input tipe
    ...
    private JPanel createComicPanel() {
        ...
        // PERBAIKAN: Inisialisasi JComboBox untuk input tipe komik
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            try (ResultSet rs = pst.executeQuery()) {
                while (rs.next()) {
                    ...
                    // PERBAIKAN: Mengubah created_at menjadi last_update sesuai gambar XAMPP Anda
    ...
    private void addComic() {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            // PERBAIKAN: Indeks parameter dimulai dari angka 1 dan mengambil value dari cbTypeInput
            ...
            // PERBAIKAN: Menggunakan executeUpdate() untuk INSERT data
            pst.executeUpdate();
            ...
            e.printStackTrace(); // Tampilkan di console untuk pelacakan error lebih spesifik
    ...
    // PERBAIKAN: Ubah parameter `JTextField` menjadi `JComponent` agar bisa menerima JComboBox
